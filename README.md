...
6 search engines (Crossref, OpenAlex, arXiv, S2, AMiner, CNKI) + pa judge relevance
collection + pa build manuscript pipeline + Tier 2 research-topic project management.
...
- **3 of 6 engines return 0 hits** in current config (S2, CORE — demo API key expired)
