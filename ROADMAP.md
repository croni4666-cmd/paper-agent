...
- **Acceptance criteria**:
  ...
  - **cookie 维护** (per user "通过其他代理" setup):
    - `C:\Users\paper-agent-user\.mavis\bin\Export-CNKICookies.ps1` (~50 LOC)
...
**Source**: `C:\Users\paper-agent-user\.paper-agent\cookies\cnki.json` (4 cookies, fresh 2026-07-15 22:21 local time)

**What was done**:
- `pa_cli/cnki_channel.py` skeleton written (commit `c4b228e`)
- `C:\Users\paper-agent-user\.mavis\bin\Export-CNKICookies.ps1` written (commits `832c392` + `8a4f81f` + `caf87f2` + `a0ca001`)
