...
- `C:\Users\paper-agent-user\.minimax\skills\paper-agent\SKILL.md` (Mavis-side
...
- `C:\Users\paper-agent-user\.minimax\skills\paper-agent\SKILL.md`: 2 references
...
2. Add at least 1 aminer sample (e.g. USER_LOCATION经编/算力券 query)
...
- **Symptom**: 6 user-downloaded PDFs in `C:/Users/paper-agent-user/Downloads/manual_pdfs/` were
...
**Script location**: `C:\Users\paper-agent-user\.mavis\bin\Add-PaperAgentTask.ps1` (UTF-8 BOM)
**Current invocation**:
```powershell
powershell -ExecutionPolicy Bypass -File "C:\Users\paper-agent-user\.mavis\bin\Add-PaperAgentTask.ps1" `
...
**Files**:
- `C:\Users\paper-agent-user\.mavis\bin\Add-PaperAgentTask.ps1` (not git-tracked; personal tool)
...
```bash
# User downloads 7 PDFs to C:/Users/paper-agent-user/Downloads/manual_pdfs/
# Then:
python -m pa_cli deep-rerank --user-pdf-dir C:/Users/paper-agent-user/Downloads/manual_pdfs/
```
...
- `C:\Users\paper-agent-user\.paper-agent\deep_rerank\manual_downloads_UPDATED_20260713_1730.md` — updated manual list with failure modes
...
**Manual download list**: `C:\Users\paper-agent-user\.paper-agent\deep_rerank\manual_downloads_20260713_170509.md`
...
| `paper-search-mcp` install path | `C:\Users\paper-agent-user\AppData\Roaming\Python\Python312\site-packages\paper_search_mcp\` |
