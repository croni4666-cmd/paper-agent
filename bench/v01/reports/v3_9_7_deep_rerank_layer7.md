...
Manual download list: `C:\Users\paper-agent-user\.paper-agent\deep_rerank\manual_downloads_v397_reconstructed.md`

## Stage 2: Full-text feature extraction (Layer 7)

- Candidates with full text extracted: 16 / 16 (100.0%)
- Output: `C:\Users\paper-agent-user\.paper-agent\deep_rerank\deep_rerank_20260714_120450.json`
