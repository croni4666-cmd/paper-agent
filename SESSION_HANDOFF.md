...
**Path**: `C:\Users\paper-agent-user\.mavis\bin\Export-CNKICookies.ps1` (per ROADMAP [P0-9])
...
**Files to add/modify**:
- `C:\Users\paper-agent-user\.mavis\bin\Export-CNKICookies.ps1` (✅ done, REWRITTEN 2026-07-15)
