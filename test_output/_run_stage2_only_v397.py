...
def build_stage1_from_previous_run(n_queries: int = 5, top_k: int = 10) -> dict:
    ...
    md_path = Path("C:/Users/paper-agent-user/.paper-agent/deep_rerank/manual_downloads_UPDATED_20260713_1730.md")
    ...
    out_md = Path("C:/Users/paper-agent-user/.paper-agent/deep_rerank/manual_downloads_v397_reconstructed.md")
...
def main():
    ...
    user_pdf_dir = Path("C:/Users/paper-agent-user/Downloads/manual_pdfs/")
