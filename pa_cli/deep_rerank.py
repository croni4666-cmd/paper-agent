...
def stage1_download_orchestration(
    ...
    md_lines = [
        ...
        "2. Save the PDF to a directory (e.g. `C:/Users/paper-agent-user/Downloads/manual_pdfs/`)",
        "3. Re-run: `python -m pa_cli deep-rerank --user-pdf-dir C:/Users/paper-agent-user/Downloads/manual_pdfs/`",
        "",
