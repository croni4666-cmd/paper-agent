...
Latest stable: v3.9.11.6 (arXiv channel + prefer routing fix).
See CHANGELOG [3.9.11.6] for the arXiv channel + cascade rework.
...
Previous in v3.9.10.x and v3.9.11.0..v3.9.11.5:
  ...
  - C:\\Users\\paper-agent-user\\.paper-agent\\sample_pool\\: SQLite + README + schema + example
