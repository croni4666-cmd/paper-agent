"""paper-agent CLI â€?academic paper fetch + lit review synthesis.

Latest stable: v3.9.12.0 (ClinicalTrials.gov engine + 2026-08-10 hotfix chain).
See CHANGELOG [3.9.12.0] for the new engine.

v3.9.11.9 (2026-08-10): Hotfix for v3.9.11.8 PubMed year filter â€?see
CHANGELOG [3.9.11.9]. esearch `pdat` filter post-filter on `year` field.

v3.9.12.0 (2026-08-10): NEW ENGINE â€?ClinicalTrials.gov (NCBI sister
site). 500K+ registered clinical trial records, free public API, no
auth. Returns trial registry records (not papers â€?different content
