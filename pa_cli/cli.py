...
def cnki_setup():
    ...
    click.echo("    C:\\Users\\paper-agent-user\\.paper-agent\\cookies\\cnki.json")
    click.echo()
...
# Canonical doc: C:\Users\paper-agent-user\.paper-agent\sample_pool\README.md
...
def sample_pool_cmd():
    ...
    See C:\\Users\\paper-agent-user\\.paper-agent\\sample_pool\\README.md for the
